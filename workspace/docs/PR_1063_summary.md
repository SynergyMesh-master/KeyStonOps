...
- **Key changes:**
  ...
  - Added MCP unified pipeline integration artifacts (baseline tied to world_class_validation): README (`workspace/mcp/namespace-mcp/README.md`), pipeline manifest (`workspace/mcp/namespace-mcp/pipelines/unified-pipeline-config.yaml`), JSON Schema (`workspace/mcp/namespace-mcp/schemas/unified-pipeline.schema.json`), TypeScript types (`workspace/mcp/namespace-mcp/types/unifiedPipeline.ts`), and Python loader (`workspace/mcp/namespace-mcp/tools/load_unified_pipeline.py`).
